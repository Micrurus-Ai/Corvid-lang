-- Auth surface for the Finance Operations Agent.
...
-- and a roles/permissions table that gates dangerous financial
-- operations (payment intents, subscription cancellations, disputes,
-- report exports, recurring payments). The agent never advises; it
-- executes operations a human with the right role has approved.

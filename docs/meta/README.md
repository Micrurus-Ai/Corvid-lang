...
Project-level documents — conventions, release policy, launch
claim audit, beta program.

## Pages

- [Project conventions](conventions.md) — naming, file
  organization, commit message rules, pre-phase chat discipline.
- [Release policy](../release-policy.md) — how we cut releases

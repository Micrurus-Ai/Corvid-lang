...
|---|---|---|---|
| Personal Executive Agent: maturity bar closed | [`examples/backend/personal_executive_agent/CLAIM.md`](../../examples/backend/personal_executive_agent/CLAIM.md) | [`phase-42-pea-maturity-2026-05-27.md`](../phases/phase-42-pea-maturity-2026-05-27.md) | `corvid app boot-summary` + `corvid app adversarial-refresh` + `corvid app pr-describe` |
| Personal Knowledge Agent: maturity bar closed | [`examples/backend/personal_knowledge_agent/CLAIM.md`](../../examples/backend/personal_knowledge_agent/CLAIM.md) | [`phase-42-pka-maturity-2026-05-28.md`](../phases/phase-42-pka-maturity-2026-05-28.md) | `corvid app boot-summary` + `corvid app adversarial-refresh` + `corvid app pr-describe` |
| Finance Operations Agent: maturity bar closed | [`examples/backend/finance_operations_agent/CLAIM.md`](../../examples/backend/finance_operations_agent/CLAIM.md) | [`phase-42-finance-maturity-2026-05-28.md`](../phases/phase-42-finance-maturity-2026-05-28.md) | `corvid app boot-summary` + `corvid app adversarial-refresh` + `corvid app pr-describe` |
| Customer Support Agent: maturity bar closed | [`examples/backend/customer_support_agent/CLAIM.md`](../../examples/backend/customer_support_agent/CLAIM.md) | [`phase-42-customersupport-maturity-2026-05-28.md`](../phases/phase-42-customersupport-maturity-2026-05-28.md) | `corvid app boot-summary` + `corvid app adversarial-refresh` + `corvid app pr-describe` |
| Code Maintenance Agent: maturity bar closed | [`examples/backend/code_maintenance_agent/CLAIM.md`](../../examples/backend/code_maintenance_agent/CLAIM.md) | [`phase-42-codemaintenance-maturity-2026-05-28.md`](../phases/phase-42-codemaintenance-maturity-2026-05-28.md) | `corvid app boot-summary` + `corvid app adversarial-refresh` + `corvid app pr-describe` |

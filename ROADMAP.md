...
- [ ] 51m-dev-console   `corvid dev` — the ONE universal, contract-driven console for every Corvid app: forms for every public agent, auth buttons, streaming execution, tool-call timeline, approval cards, citation/source viewer, cost + latency, traces + replay, model comparison, error inspection. Likely the fastest path to a compelling demo.

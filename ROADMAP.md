...
- [ ] `35V2-P42-G0-imported-struct-2`  Codegen: `cl_type_for` / `reject_unsupported_types` accept `Type::ImportedStruct` (width I64, identical to `Struct`). Smallest end-to-end win — should let the first app's cdylib link.

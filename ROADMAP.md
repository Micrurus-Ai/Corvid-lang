...
- [ ] 48d-imported-struct-4-disposition   **[= `35V2-P42-G0-imported-struct-4`, marked "only if reached"]**   Entry-agent + native-prompt boundaries accepting `ImportedStruct` through the struct JSON codec. Confirm whether any pre-launch surface actually reaches it; ship it or close it as explicitly post-v1.0.

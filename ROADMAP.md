...
- [ ] 51b-openapi-projection   Standard OpenAPI 3.1 + JSON Schema (`target/contracts/openapi.json`) from the shared model — routes, params, bodies, responses, auth, error status codes, uploads, pagination where expressible. Consumable by any existing OpenAPI tooling.

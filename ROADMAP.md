...
- [ ] 51d-ui-hints   `@ui(label:, placeholder:, currency:, multiline:, ...)` optional presentation hints on types/fields; the contract keeps semantic constraints and display suggestions in separate channels.

...
- [ ] 51k-mock-idp-and-fuzz   Local mock identity provider for tests; source-bypass mutators + byte-fuzz over the OAuth/JWT parsers; the auth safe-defaults registered as guarantee rows.

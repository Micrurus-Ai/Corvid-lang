...
- [ ] 46b-system-prompts-and-message-blocks   **[closes audit B7 first half]** Implement the multi-message prompt form book ch 11 already documents: `system:` / `user:` role blocks in `parser/prompt.rs`, AST `PromptMessage` nodes, dispatch assembling a real message array per provider. 44b's Planned marker comes off.

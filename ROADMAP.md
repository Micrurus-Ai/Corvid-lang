...
- [ ] 49d-connector-scaffolds   `corvid add connector <provider>` for the shipped set (gmail/ms365/slack/github/linear/files): generated tool-wrapper module + corvid.toml scopes + env checklist; refuses unknown providers with the shipped list. Tests: scaffold golden per provider, generated module compiles.

...
- [ ] 51i-account-linking   Explicit-confirmation linking flow (sign in → link → authenticate new provider → confirm ownership → approve → audit); verified-domain policy option; never silent email-match merge.

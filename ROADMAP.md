...
- [ ] 47d-schedule-execution-decision   **[closes audit M16]** `schedule` declarations parse + typecheck + warn W0280 but never fire. Decide: ship a minimal scheduler runner for v1.0 or promote the warning into the book/reference as an explicit documented limitation. No silent middle.

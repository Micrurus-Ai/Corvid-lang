...
- [ ] 51f-uploads-and-pagination   `Upload<Pdf>` (accepted MIME/max size/upload endpoint/progress/retention) and cursor/stream pagination surfaces in source + contract.

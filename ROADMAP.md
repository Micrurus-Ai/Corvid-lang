...
- [ ] 51n-react-hooks   `@corvid/react` optional hooks (`useCorvidAgent`, `useCorvidApprovals`, `useCorvidPaginated`) — generic implementations specialized by generated types.

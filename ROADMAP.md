...
- [ ] 50d-token-streaming   End-to-end token streaming: adapter → agent (Stream surface) → `corvid serve` (SSE). The checker's Stream/backpressure types are ahead of the runtime; close the gap so AI apps feel modern and every demo is alive.

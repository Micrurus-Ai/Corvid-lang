...
- [ ] 45n-type-aliases-and-named-struct-literals   The two remaining doc-claimed forms: `type CustomerId = String` (grammar.md:65) and named-field construction `Decision { refund: true }` + `..base` update spread (grammar.md:269-271; positional `TypeName(v1, v2)` stays). Lower priority than 45a–45m; may split.

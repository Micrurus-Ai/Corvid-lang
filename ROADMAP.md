...
- [ ] 49e-capability-surface-contract   The invention contract sweep: FEATURES.md capability-surface section, README catalog entries, inventions.md rows, tour topic(s), book/guide coverage (extending-your-agent guide), stdlib/reference docs; launch-story polish pass over the `corvid add` UX output.

...
- [ ] 45o-effect-and-model-exports   `collect_public_exports` (`corvid-resolve/src/modules.rs:225-253`) gains Effect + Model (and audit Extend) export arms so `import "./std/json" use json_egress_read` resolves; retire the redeclare-inline workaround the typed-decoder convention documents; migrate std module docs.

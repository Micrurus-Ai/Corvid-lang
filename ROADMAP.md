...
- [ ] 48c-ai-helper-sweep   The genuinely-LLM-shaped helpers still filed: `corvid connectors mock-fixture-gen` + the remaining `35V2-P41-H` sub-slice, and the 3 remaining `35V2-P43-T` helpers. One slice each, or an explicit re-file to post-v1.0 with rationale per helper.

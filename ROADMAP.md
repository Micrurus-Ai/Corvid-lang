...
- [ ] 51o-sdk-generators   `corvid generate sdk --language ts|--framework react` now; Swift/Kotlin/Python generators from the SAME shared contract (scaffolded, extended as demand proves).

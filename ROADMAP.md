...
- [ ] 51q-frontend-scaffolding   `corvid generate frontend --framework react` starter templates (client/generated/components/pages) the developer then owns and modifies.

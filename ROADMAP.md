...
- [ ] 51l-ts-client   `@corvid/client` generic browser package (HTTP, SSE transport, auth/session, errors) + TS type/method generator from the contract. Generated code stays small; transport/behavior is reused, not regenerated per app.

...
pub use auth::{
    ...
    ExternalIdentityLink, JwtContractDiagnostic, JwtVerificationContract, OAuthCallbackResolution,
    OAuthStateCreate, OAuthStatePurpose, OAuthStateRecord, PermissionRequirement,

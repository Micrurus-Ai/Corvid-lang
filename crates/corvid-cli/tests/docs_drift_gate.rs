...
const EXEMPT_GUIDES: &[(&str, &str)] = &[
    // 43W landed the auth.md rewrite — entry removed; the gate now
    // enforces on auth.md.
    ...
    ("observability.md", "35V2-P38-E-LR-observability-guide-rewrite"),
    ("persistence.md", "35V2-P38-E-LR-persistence-guide-rewrite"),
];
